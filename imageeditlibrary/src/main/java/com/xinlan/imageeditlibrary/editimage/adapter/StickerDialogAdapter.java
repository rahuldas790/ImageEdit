...
public class StickerDialogAdapter extends BaseAdapter {
    ...
    public StickerDialogAdapter(Context mContext) {
        this.mContext = mContext;
        for (int i = 0; i < stickerPath.length; i++) {
            addStickerImages(stickerPath[i]);
        }
    }
...
//        pathList.clear();
    ...
    private final class ImageClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Log.i("Rahul", "Sticker Click performed");
