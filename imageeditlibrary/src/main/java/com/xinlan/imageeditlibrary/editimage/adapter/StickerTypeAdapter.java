...
import com.xinlan.imageeditlibrary.editimage.fragment.FragmentDialog;
import com.xinlan.imageeditlibrary.editimage.fragment.StirckerFragment;

import static com.xinlan.imageeditlibrary.editimage.fragment.MainMenuFragment.fm;
import static com.xinlan.imageeditlibrary.editimage.fragment.MainMenuFragment.height;
import static com.xinlan.imageeditlibrary.editimage.fragment.MainMenuFragment.overlay;
import static com.xinlan.imageeditlibrary.editimage.fragment.MainMenuFragment.width;
...
public class StickerTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static final String[] typeNames = {"type1", "type2", "type3", "type4", "type5", "type6"};
