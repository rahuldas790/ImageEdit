...
public class ColorListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public class ColorViewHolder extends ViewHolder {
        CircleImageView colorPanelView;

        public ColorViewHolder(View itemView) {
            super(itemView);
            this.colorPanelView = (CircleImageView) itemView.findViewById(R.id.color_panel_view);
        }
    }// end inner class
...
//        holder.colorPanelView.setBackgroundColor(colorsData[position]);
        Bitmap bmp = Bitmap.createBitmap(25, 25, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bmp);
        canvas.drawColor(colorsData[position]);
        holder.colorPanelView.setImageBitmap(bmp);
...
//                holder.colorPanelView.setBorderColor(colorsData[4]);
            }
        });
    }
