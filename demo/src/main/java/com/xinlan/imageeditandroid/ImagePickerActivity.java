...
import com.xinlan.imageeditandroid.utils.ImageInternalFetcher;
...
//        setupActionBar();
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.action_btn_done) {
            ...
            if (uris.length >= 2)
                ...
                Toast.makeText(this, "Select " + (2 - uris.length) + " more image(s)", Toast.LENGTH_SHORT).show();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return GalleryFragment.newInstance(ImagePickerActivity.this);
                default:
                    return null;
            }
        }
