...
public class FileUtils {
	public static final String FOLDER_NAME = "zersey";

	/**
	 * Gets the folder path where the file is stored
	 * 
	 * @return
	 */
	...
	public static File genEditFile(){
		return FileUtils.getEmptyFile("rahul"
	...
	public static long getFolderSize(File file) throws Exception {
		...
		try {
			...
			for (int i = 0; i < fileList.length; i++) { // If there are documents below
	...
	/** * Formatting units * * @param size * @return */
